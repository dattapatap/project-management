@php
    ...
    $showNsd = $isBm
        || ($user->hasRole(['Sales-Executive', 'Team-Leader']) && !$isAdmin && $deptId == 1);
...
<ul class="metismenu list-unstyled" id="side-menu">
    ...
    <li class="menu-title menu-title-dept">
        <span class="dept-label">ERP - Digitalnock</span>
    </li>
    ...
    @if ($isAdmin)
    <li class="dept-item dept-item--admin {{ is_client_list_route() ? 'mm-active' : '' }}">
    ...
    @if ($showOdProjects)
    <li class="dept-item dept-item--od {{ request()->is('projects*') ? 'mm-active' : '' }}">
    ...
    <li class="dept-item dept-item--nsd {{ is_client_list_route() ? 'mm-active' : '' }}">
        <a href="{{ client_list_url('Fresh') }}" class="waves-effect {{ is_client_list_route() ? 'active' : '' }}">
            <i class="mdi mdi-office-building-outline"></i><span>Companies</span>
        </a>
    </li>
    @endif
    ...
    @if ($user->hasRole('Team-Leader') || $isBm)
    <li class="dept-item dept-item--nsd {{ request()->is('reports/employees*') ? 'mm-active' : '' }}">
        <a href="{{ route('reports.employees') }}" class="waves-effect {{ request()->is('reports/employees*') ? 'active' : '' }}">
            <i class="mdi mdi-account-supervisor"></i><span>Team Report</span>
        </a>
    </li>
    @endif
    ...
    <li class="dept-item dept-item--reports {{ request()->is('reports/*') || request()->is('mysts*') ? 'mm-active' : '' }}">
        <a href="javascript:void(0);" class="has-arrow waves-effect">
            <i class="mdi mdi-file-chart-outline"></i><span>Reports</span>
        </a>
        <ul class="sub-menu">
            @if ($isAuthority)
            <li class="{{ request()->is('mysts*') ? 'mm-active' : '' }}"><a href="{{ url('mysts/searchsts') }}">STS Report</a></li>
            <li class="{{ request()->is('reports/dsr/searchdsr*') ? 'mm-active' : '' }}"><a href="{{ url('reports/dsr/searchdsr') }}">DSR Report</a></li>
            ...
            <li class="{{ request()->is('reports/operations*') ? 'mm-active' : '' }}"><a href="{{ route('reports.operations') }}">Operations Work</a></li>
            <li class="{{ request()->is('reports/employee*') ? 'mm-active' : '' }}"><a href="{{ route('reports.employees') }}">Employees</a></li>
        </ul>
    </li>
    @endif
