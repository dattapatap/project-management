                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                <div class="card-body">
                                    <form method="POST" id="frm_basicInfo">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="d-flex">
                                                    <div class="ml-3 mr-4">
                                                        <h1 class="display-6 mb-0"> <i class="mdi mdi-account-outline"></i></h1>
                                                    </div>
                                                    <div class="flex-1">
                                                        <p class="mb-2">Name</p>
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="d-flex">
                                                    <div class="ml-3 mr-4">
                                                        <h1 class="display-6 mb-0"> <i class="mdi mdi-cellphone-iphone"></i></h1>
                                                    </div>
                                                    <div class="flex-1">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="d-flex">
                                                    <div class="ml-3 mr-4">
                                                        <h1 class="display-6 mb-0"> <i class="mdi mdi-email-open-outline"></i> </h1>
                                                    </div>
                                                    <div class="flex-1">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="d-flex">
                                                    <div class="ml-3 mr-4">
                                                        <h1 class="display-6 mb-0"> <i class="mdi mdi-cake-variant"></i> </h1>
                                                    </div>
                                                    <div class="flex-1">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="d-flex">
                                                    <div class="ml-3 mr-4">
                                                        <h1 class="display-6 mb-0"> <i class="mdi mdi-gender-male-female"></i> </h1>
                                                    </div>
                                                    <div class="flex-1">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="d-flex">
                                                    <div class="ml-3 mr-4">
                                                        <h1 class="display-6 mb-0"> <i class="mdi mdi-calendar-clock"></i> </h1>
                                                    </div>
                                                    <div class="flex-1">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="d-flex">
                                                    <div class="ml-3 mr-4">
                                                        <h1 class="display-6 mb-0"> <i class="mdi mdi-code-not-equal"></i> </h1>
                                                    </div>
                                                    <div class="flex-1">
                                            ...
                                            <div class="col-md-6 mb-4">
                                                <div class="d-flex">
                                                    <div class="ml-3 mr-4">
                                                        <h1 class="display-6 mb-0"> <i class="mdi mdi-target-account"></i> </h1>
                                                    </div>
                                                    <div class="flex-1">
                                    ...
                                    <span class="mdi mdi-pencil-plus-outline float-end btn_edit_info"
                                        style="position: absolute;margin-right: 2%;top: 3%;right: 3%; display:block;cursor: pointer;color: #556ee6;">
                                        edit
                                    </span>
                                </div>
                            </div>
