    ...
    <div class="card erp-table-card">
        <div class="card-body">
            <div class="table-responsive">
                <table id="engagementsTable" class="table table-premium table-centered table-striped table-hover w-100">
                    <thead class="thead-custom-teal">
                        <tr>
                            <th class="text-center" style="width: 5%">#</th>
                            <th style="width: 25%">Client / Order No</th>
                            <th style="width: 25%">Engagement Details</th>
                            <th style="width: 18%">Attribution</th>
...
<script>
    $(function() {
        ...
        $('#engagementCategory').on('change', function() {
            ...
            $('#engagementSubCategory').empty().append('<option value="">Select Sub-Category</option>');
            if (!id) return;
            $.get("{{ url('projectcategory/subcategories') }}", {
                    projcategory: id
                },
                function(res) {
