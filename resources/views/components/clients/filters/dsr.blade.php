    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18">Search DSR</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="header-title"> Search DSR </h4>
                </div>
                <div class="card-body">
                    <form class="" id="frm-search-dsr" action="{{ route('report.searchdsr')}}" >
                        <div class="row">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="from_date" id="from_date" value="@if($search) {{ $search['from_date'] }} @endif" class="form-control" placeholder="Date" required>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    @if(!$clients->isEmpty())
                                    &nbsp;&nbsp;
                                    <button type="button" class="btn btn-primary btn-dsr-export">
                    ...
                    @else
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <span class=" text-danger"> NO DSR FOUND</span>
                            </div>
                        </div>
                    @endif
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header" style="border-bottom: 2px solid #3fbeaa;">
                <h5 class="modal-title mt-0" id="myExtraLargeModalLabel">MY DSR</h5>
