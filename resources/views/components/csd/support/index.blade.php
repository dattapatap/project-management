...
<div class="container-fluid erp-page erp-page--csd">
    ...
    'actions' => '<a href="' . url('/') . '" class="btn btn-outline-primary btn-sm mr-2"><i class="mdi mdi-arrow-left mr-1"></i> Back</a><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#mdlAdd"><i class="mdi mdi-plus"></i> New Ticket</button>',
    ])
...
<script>
    $(function() {
        ...
        $('#frmAdd').on('submit', function(e) {
            e.preventDefault();
            csdApi.post("{{ route('csd.support.store') }}", $(this).serialize(),
                function() {
        ...
        $('#frmEdit').on('submit', function(e) {
            e.preventDefault();
            csdApi.put('/csd/support/' + $('#editId').val(), $(this).serializeArray().reduce((o, i) => {
                o[i.name] = i.value;
                return o;
            }, {}), function() {
