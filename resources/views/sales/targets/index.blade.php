...
<div class="container-fluid erp-page pb-5">
    <div class="erp-page-header my-4">
        ...
        <div class="erp-page-header__actions d-flex align-items-center">
            ...
            @if(Auth::user()->hasRole(['Admin', 'Branch-Manager', 'Team-Leader']))
                ...
                <div class="card-body">
                    ...
                    @if(empty($targets))
                        <div class="text-center py-5 text-muted">
                            ...
                            <p class="mt-2 font-weight-semibold">No targets set for you this year yet.</p>
                        </div>
                    @else
                        <div class="target-list">
                            @foreach($targets as $tgt)
                                ...
                                <div class="target-item p-3 mb-3 rounded border" style="background: #f8fafc; border-left: 4px solid #3b82f6 !important;">
